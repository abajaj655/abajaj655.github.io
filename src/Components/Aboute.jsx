        ...
        <Container maxW={"7xl"} id={"About" && "Home"}>
          ...
          >
            <Stack flex={1} spacing={{ base: 5, md: 10 }}>
              ...
              >
                <Text>Hi,I'am Ashish Bajaj</Text>
                <Text
                  as={"span"}
                  color={useColorModeValue("#fbad50", "#3182CE")}
              ...
              >
                <Button
                  ...
                  px={6}
                  color={"white"}
                  bg={useColorModeValue("#fbad50", "#4299E1")}
            ...
            >
              ...
              >
                <Image
                  ...
                  // h={"100%"}
                  src={
                    "https://avatars.githubusercontent.com/u/105944819?v=4"
                  }
                />
              </Box>
            </Flex>
